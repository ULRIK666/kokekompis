...
<body>
    ...
    <table class="styled-table">
        <tr>
            ...
            <th class="table-header">Slettet?</th>
        ...
        $sql = "SELECT brukere.id AS bruker_id, brukere.brukernavn, brukere.navn, roller.rolle, brukere.rolle_id, brukere.slettet_tid
        FROM brukere
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            if ($row['bruker_id'] != $_SESSION['bruker_id']) {
                ...
                echo "</td>";
                echo "<td>";
                if ($row['slettet_tid'] != null) {
                    echo "JA ($row[slettet_tid])";
                } else {
                    echo "NEI";
                }
                echo "</td>";
